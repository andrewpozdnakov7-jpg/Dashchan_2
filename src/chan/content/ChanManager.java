...
public class ChanManager {
	...
	private static Extension loadBuiltinEjchan(Fingerprints applicationFingerprints) {
		MainApplication application = MainApplication.getInstance();
		ExtensionItem extensionItem = new ExtensionItem(ExtensionItem.Type.CHAN, BUILTIN_EJCHAN_NAME, "Ejchan",
				ExtensionItem.TrustState.TRUSTED, application.getPackageName(), BuildConfig.VERSION_NAME,
				BuildConfig.VERSION_CODE, application.getApplicationInfo(), applicationFingerprints,
				MAX_VERSION, true, R.drawable.ic_custom_ejchan, null, null,
				"com.mishiranu.dashchan.chan.ejchan.EjchanChanConfiguration",
				"com.mishiranu.dashchan.chan.ejchan.EjchanChanPerformer",
				"com.mishiranu.dashchan.chan.ejchan.EjchanChanLocator",
				"com.mishiranu.dashchan.chan.ejchan.EjchanChanMarkup", true);
		LoadChanResult result = loadChan(extensionItem, application.getPackageManager());
		return new Extension(extensionItem.changeLoadError(result.error), result.chan);
	}
	...
	private static Extension loadBuiltinArhivach(Fingerprints applicationFingerprints) {
		...
		ExtensionItem extensionItem = new ExtensionItem(ExtensionItem.Type.CHAN, BUILTIN_ARHIVACH_NAME, "Arhivach",
				ExtensionItem.TrustState.TRUSTED, application.getPackageName(), BuildConfig.VERSION_NAME,
				BuildConfig.VERSION_CODE, application.getApplicationInfo(), applicationFingerprints,
				MAX_VERSION, true, R.drawable.ic_custom_arhivach, null, null,
				"com.mishiranu.dashchan.chan.arhivach.ArhivachChanConfiguration",
				"com.mishiranu.dashchan.chan.arhivach.ArhivachChanPerformer",
				"com.mishiranu.dashchan.chan.arhivach.ArhivachChanLocator",
				"com.mishiranu.dashchan.chan.arhivach.ArhivachChanMarkup", true);
		LoadChanResult result = loadChan(extensionItem, application.getPackageManager());
		return new Extension(extensionItem.changeLoadError(result.error), result.chan);
	}
	...
	private static Extension loadBuiltinEndchan(Fingerprints applicationFingerprints) {
		MainApplication application = MainApplication.getInstance();
		ExtensionItem extensionItem = new ExtensionItem(ExtensionItem.Type.CHAN, BUILTIN_ENDCHAN_NAME, "Endchan",
				ExtensionItem.TrustState.TRUSTED, application.getPackageName(), BuildConfig.VERSION_NAME,
				BuildConfig.VERSION_CODE, application.getApplicationInfo(), applicationFingerprints,
				MAX_VERSION, true, R.drawable.ic_custom_endchan, null, null,
				"com.mishiranu.dashchan.chan.endchan.EndchanChanConfiguration",
				"com.mishiranu.dashchan.chan.endchan.EndchanChanPerformer",
				"com.mishiranu.dashchan.chan.endchan.EndchanChanLocator",
				"com.mishiranu.dashchan.chan.endchan.EndchanChanMarkup", true);
		LoadChanResult result = loadChan(extensionItem, application.getPackageManager());
		return new Extension(extensionItem.changeLoadError(result.error), result.chan);
	}
	...
	private static Extension loadBuiltinPikabu(Fingerprints applicationFingerprints) {
		...
		ExtensionItem extensionItem = new ExtensionItem(ExtensionItem.Type.CHAN, BUILTIN_PIKABU_NAME, "Pikabu",
				ExtensionItem.TrustState.TRUSTED, application.getPackageName(), BuildConfig.VERSION_NAME,
				BuildConfig.VERSION_CODE, application.getApplicationInfo(), applicationFingerprints,
				MAX_VERSION, true, R.drawable.ic_custom_pikabu, null, null,
				"com.mishiranu.dashchan.chan.pikabu.PikabuChanConfiguration",
				"com.mishiranu.dashchan.chan.pikabu.PikabuChanPerformer",
				"com.mishiranu.dashchan.chan.pikabu.PikabuChanLocator",
				"com.mishiranu.dashchan.chan.pikabu.PikabuChanMarkup", true);
		LoadChanResult result = loadChan(extensionItem, application.getPackageManager());
		return new Extension(extensionItem.changeLoadError(result.error), result.chan);
	}

	private static Extension loadBuiltinD3(Fingerprints applicationFingerprints) {
		MainApplication application = MainApplication.getInstance();
		ExtensionItem extensionItem = new ExtensionItem(ExtensionItem.Type.CHAN, BUILTIN_D3_NAME, "d3.ru",
				ExtensionItem.TrustState.TRUSTED, application.getPackageName(), BuildConfig.VERSION_NAME,
				BuildConfig.VERSION_CODE, application.getApplicationInfo(), applicationFingerprints,
				MAX_VERSION, true, R.drawable.ic_custom_d3, null, null,
				"com.mishiranu.dashchan.chan.d3ru.D3ChanConfiguration",
				"com.mishiranu.dashchan.chan.d3ru.D3ChanPerformer",
				"com.mishiranu.dashchan.chan.d3ru.D3ChanLocator",
				"com.mishiranu.dashchan.chan.d3ru.D3ChanMarkup", true);
		LoadChanResult result = loadChan(extensionItem, application.getPackageManager());
		return new Extension(extensionItem.changeLoadError(result.error), result.chan);
	}
	...
	private ChanManager() {
		...
		if (MainApplication.getInstance().isMainProcess()) {
			...
			Extension builtInD3 = loadBuiltinD3(applicationFingerprints);
			extensions.add(builtInD3);
			usedExtensionNames.add(builtInD3.item.name);
