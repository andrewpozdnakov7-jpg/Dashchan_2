...
public class PhotoView extends View implements ScaleGestureDetector.OnScaleGestureListener {
	...
	public void dispatchSimpleClick(boolean longClick, float x, float y) {
		if (listener != null && !hasImage() && isAttachedToWindow()) {
			if (longClick) {
	...
	public void dispatchDirectDoubleClick(float x, float y) {
		if (listener != null && isAttachedToWindow()) {
			listener.onDoubleClick(this, x, y);
		}
	}

	public void dispatchDirectLongClick(float x, float y) {
		if (listener != null && isAttachedToWindow()) {
			listener.onLongClick(this, x, y);
		}
	}
