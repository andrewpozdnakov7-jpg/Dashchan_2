...
public class EndchanChanLocator extends ChanLocator {
	private static final Pattern BOARD_PATH = Pattern.compile("/[A-Za-z0-9_-]+(?:/(?:(?:catalog|\\d+)\\.html)?)?");
	private static final Pattern THREAD_PATH = Pattern.compile("/[A-Za-z0-9_-]+/res/(\\d+)\\.html");
